...
?>
    ...
    <div class="jumbotron">
        <div class="container">
            ...
            <h5><?php /*echo '&nbsp;'; */?></h5>-->
            <h6>Direkt zum Tippspiel der Bundesliga 2022/2023 geht es hier entlang!<?php echo '&nbsp;'; ?> </h6>
            <p><a class="btn btn-primary btn-lg" href="tipps.php?season=9" role="button">Bundesliga 2022/23 »</a></p>
            <h5><?php echo '&nbsp;'; ?></h5>
